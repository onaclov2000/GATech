...
for i in range(0,100):
	...
	print "Fit Time: " + str(end - start)
	X_test_rp = rp.transform(X_test_rp)
	k_means_results('KMeans Live RP Feature Selection ' + str(i), [X_rp,y], [X_test_rp, y_test],  '1st RP Component', '2nd RP Component', colormap = True)
	plot_scatter('KMeans Live Feature Selection ' + str(i), 'RP', X_rp, y,  '1st RP Component', '2nd RP Component' )
